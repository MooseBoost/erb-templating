...
class SiteGenerator
  def make_index!
    ...
    Movie.all.each do |movie|
      fileHtml.puts %[<li><a href="movies/#{movie.url}">"#{movie.title}"</a></li>]
    end  
          ...
          # <li><a href="movies/logans_run.html">Logan's Run</a></li>
          ...
          # <li><a href="movies/pans_labyrinth.html">Pan's Labyrinth</a></li>
